...
def get_ea_games():
    ea_path = get_user_input("Please enter the path for EA games or press Enter to skip: ")
    if ea_path is None:
        return []
...
def get_epic_games():
    epic_path = get_user_input("Please enter the path for Epic Games or press Enter to skip: ")
...
def get_gog_games():
    gog_path = get_user_input("Please enter the path for GOG games or press Enter to skip: ")
    if gog_path is None:
        return []
...
def get_battlenet_games():
    battlenet_path = get_user_input("Please enter the path for Battle.net games or press Enter to skip: ")
