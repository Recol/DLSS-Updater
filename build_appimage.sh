...
#
# NOTE: For GLIBC compatibility with Ubuntu 22.04, build this on Ubuntu 22.04 WSL2
# Install with: wsl --install -d Ubuntu-22.04
...
echo "Step 0: Ensuring system dependencies are installed..."
sudo apt-get update -qq
sudo apt-get install -y -qq wget file libfuse2

# Download Flet client for bundling (not included in Python package)
echo "Step 1: Downloading Flet client for bundling..."
...
echo "Step 2: Building PyInstaller binary..."
...
echo "Step 4: Creating AppRun entry point..."
...
echo "Step 7: Copying AppStream metadata..."
...
echo "Step 9: Getting appimagetool..."
...
# Build AppImage
echo "Step 10: Building AppImage..."
mkdir -p dist
